...
export const metadata: Metadata = {
  title: 'Privacy Policy | Calm Ledger',
};
    ...
    <div className="min-h-screen bg-[#F1F4F2] text-[#16232B] font-[var(--font-plex)] selection:bg-[#2F6F62] selection:text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-24 pb-32">
        ...
        <div className="space-y-8 opacity-80 leading-relaxed text-sm md:text-base">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-[#16232B]">1. Introduction</h2>
            <p>Welcome to Calm Ledger. We are committed to protecting your personal information and your right to privacy. Because we deal with sensitive financial simulations, our architecture is designed to minimize the data we store on our servers.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3 text-[#16232B]">2. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-[#16232B]">3. How We Use Your Information</h2>
            <p>We use your information exclusively to provide, operate, and maintain the Calm Ledger platform. We do not sell your personal or financial data to third parties, advertisers, or data brokers.</p>
          </section>

          <section>
            <h2 className="text-xl font-bold mb-3 text-[#16232B]">4. Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-[#16232B]">5. Contact Us</h2>
